...
group "Examples"
  ...
  include "examples/03_EntityComponentSystem"
  include "examples/04_OBJs_Lights"
  include "examples/05_DirectX11"
  include "examples/06_NvidiaPhysics"
  include "examples/07_Demo"
  include "examples/08_Demo2"
